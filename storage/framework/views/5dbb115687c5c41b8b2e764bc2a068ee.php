...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-white leading-tight">
            <?php echo e(__('app.add_new')); ?> <?php echo e(__('app.book')); ?>
                ...
                <div class="p-6 text-gray-900">
                    <div class="container-fluid px-4">
                        <div class="flex justify-between items-center mb-4">
                            <h2 class="text-3xl font-extrabold text-primary-header"><?php echo e(__('app.add_new')); ?> <?php echo e(__('app.book')); ?></h2>
...
unset($__errorArgs, $__bag); ?>" 
                                                ...
                                                <option value="Ficción" <?php echo e(old('categoria') == 'Ficción' ? 'selected' : ''); ?>><?php echo e(__('app.fiction')); ?></option>
                                                <option value="No Ficción" <?php echo e(old('categoria') == 'No Ficción' ? 'selected' : ''); ?>><?php echo e(__('app.non_fiction')); ?></option>
                                                <option value="Ciencia" <?php echo e(old('categoria') == 'Ciencia' ? 'selected' : ''); ?>><?php echo e(__('app.science')); ?></option>
                                                <option value="Tecnología" <?php echo e(old('categoria') == 'Tecnología' ? 'selected' : ''); ?>><?php echo e(__('app.technology')); ?></option>
                                                <option value="Historia" <?php echo e(old('categoria') == 'Historia' ? 'selected' : ''); ?>><?php echo e(__('app.history')); ?></option>
                                                <option value="Arte" <?php echo e(old('categoria') == 'Arte' ? 'selected' : ''); ?>><?php echo e(__('app.art')); ?></option>
                                            </select>
...
unset($__errorArgs, $__bag); ?>" 
                                                   id="ubicacion" 
                                                   name="ubicacion" 
                                                   value="<?php echo e(old('ubicacion')); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                                    ...
                                                    name="estado" 
                                                    required>
                                                <option value="nuevo" <?php echo e(old('estado') == 'nuevo' ? 'selected' : ''); ?>><?php echo e(__('app.new')); ?></option>
                                                <option value="bueno" <?php echo e(old('estado') == 'bueno' ? 'selected' : ''); ?>><?php echo e(__('app.good')); ?></option>
                                                <option value="regular" <?php echo e(old('estado') == 'regular' ? 'selected' : ''); ?>><?php echo e(__('app.regular')); ?></option>
                                                <option value="deteriorado" <?php echo e(old('estado') == 'deteriorado' ? 'selected' : ''); ?>><?php echo e(__('app.deteriorated')); ?></option>
                                            </select>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="file" accept="image/*" class="form-input mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 <?php $__errorArgs = ['portada'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="portada" name="portada">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="flex justify-end gap-2 mt-4">
                                    ...
                                    <button type="submit" class="btn-confirm px-4 py-2 rounded-md font-semibold text-xs uppercase tracking-widest">
                                        <i class="fas fa-save mr-2"></i> <?php echo e(__('app.save_book')); ?>
...
<?php endif; ?> <?php /**PATH C:\Users\HP\BiblioTech2\resources\views/libros/create.blade.php ENDPATH**/ ?>