...
<?php endif; ?>
        ...
        <div class="flex items-center justify-center mt-4">
            <a href="<?php echo e(route('auth.google')); ?>" class="inline-flex items-center px-4 py-2 bg-red-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-700 focus:bg-red-700 active:bg-red-900 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition ease-in-out duration-150 transform hover:scale-105 hover:shadow-lg">
                <img src="https://www.google.com/images/branding/googleg/1x/googleg_standard_color_128dp.png" alt="Logo de Google" class="w-4 h-4 mr-2">
...
<?php endif; ?>
<?php /**PATH C:\Users\HP\BiblioTech2\resources\views/auth/login.blade.php ENDPATH**/ ?>