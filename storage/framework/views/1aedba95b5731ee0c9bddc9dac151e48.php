<section>
    <header>
        <h2 class="text-lg font-medium text-gray-900">
            <?php echo e(__('app.profile_information')); ?>

        </h2>

        <p class="mt-1 text-sm text-gray-600">
            <?php echo e(__('app.profile_information_description')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-label','data' => ['for' => 'name','value' => __('app.name')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['for' => 'name','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('app.name'))]); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e(__('app.save')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH C:\Users\HP\BiblioTech2\resources\views/profile/partials/update-profile-information-form.blade.php ENDPATH**/ ?>