                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $prestamos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prestamo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td class="py-2 px-4 border-b"><?php echo e($prestamo->created_at); ?></td>
                                    <td class="py-2 px-4 border-b"><?php echo e(ucfirst($prestamo->estado ?? 'activo')); ?></td>
                                </tr>
...
<?php endif; ?> <?php /**PATH C:\Users\HP\BiblioTech2\resources\views/alumno/prestamos.blade.php ENDPATH**/ ?>