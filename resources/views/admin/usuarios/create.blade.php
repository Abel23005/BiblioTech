                ...
                <div class="p-6 text-gray-900">
                    <div class="container">
                        ...
                        <form action="{{ route('usuarios.store') }}" method="POST">
                            ...
                            <div class="mb-4">
                                <label for="nombre" class="block text-sm font-medium text-gray-700 mb-1">{{ __('app.name') }}</label>
                                <input type="text" class="form-input mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" id="nombre" name="nombre" value="{{ old('nombre') }}" required>
                            </div>
